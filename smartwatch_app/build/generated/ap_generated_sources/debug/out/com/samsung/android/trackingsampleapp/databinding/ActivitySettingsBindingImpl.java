...
public class ActivitySettingsBindingImpl extends ActivitySettingsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.text_gender, 1);
        sViewsWithIds.put(R.id.radio_profile, 2);
        sViewsWithIds.put(R.id.radio_profile1, 3);
        sViewsWithIds.put(R.id.radio_profile2, 4);
        sViewsWithIds.put(R.id.radio_Default, 5);
        sViewsWithIds.put(R.id.button_ok, 6);
        sViewsWithIds.put(R.id.app_version, 7);
        sViewsWithIds.put(R.id.app_version_value, 8);
        sViewsWithIds.put(R.id.sdk_version, 9);
        sViewsWithIds.put(R.id.sdk_version_value, 10);
    }
    // views
    @NonNull
